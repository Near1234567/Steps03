      ...
      <div className="grid md:grid-cols-2 gap-12 md:gap-24 items-center">
        ...
        >
          ...
          <div className="relative p-3 md:p-5 bg-white shadow-[0_40px_80px_-20px_rgba(0,0,0,0.2)] transition-all duration-[1.2s] ease-[cubic-bezier(0.23,1,0.32,1)] transform -rotate-2 md:-rotate-3 group-hover:rotate-0 origin-center group-hover:shadow-[0_60px_120px_-20px_rgba(0,0,0,0.3)]">
            <div className="relative overflow-hidden aspect-[3/4] bg-zen-beige/20">
              {data.bio.imageUrl ? (
                <img 
                ...
                <div className="w-full h-full flex items-center justify-center text-[8px] uppercase tracking-widest text-zen-taupe/40 font-bold italic">Portrait Artiste</div>
              )}
             ...
             <div className="relative">
                ...
                >
                   {data.bio.secondaryImageUrl ? (
                    ...
                    <div className="text-[8px] uppercase tracking-widest text-zen-taupe/40 font-bold text-center">Atelier</div>
                   )}
                </motion.div>
             </div>
