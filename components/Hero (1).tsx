      ...
      <div className="container mx-auto px-6 grid lg:grid-cols-2 gap-24 lg:gap-40 items-center group">
        ...
        >
            ...
            <motion.div 
              ...
              className="relative w-full h-full bg-white p-3 md:p-6 shadow-[0_40px_100px_-20px_rgba(0,0,0,0.15)] flex items-center justify-center transition-all duration-1000"
            >
              {/* Zone de clipping pour les images d'art */}
              <div className="relative w-full h-full overflow-hidden z-10 flex items-center justify-center bg-zen-stone/5">
