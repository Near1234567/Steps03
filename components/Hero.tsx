    ...
    <div id="home" className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden bg-zen-ivory">
      ...
      <div className="container mx-auto px-6 grid lg:grid-cols-2 gap-24 lg:gap-40 items-center group">
          ...
          >
            ...
            >
              ...
              <motion.span 
                ...
                className="text-zen-gold drop-shadow-sm whitespace-nowrap"
              >
        ...
        <div className="order-1 lg:order-2 flex justify-center">
            <div className="relative w-full max-w-[360px] sm:max-w-xl aspect-[4/5] sm:aspect-square group flex items-center justify-center">
            {/* Conteneur Diaporama - Clean & Minimalist */}
            <motion.div 
              whileHover={{ scale: 1.02, rotate: 1 }}
              className={`relative w-full h-full bg-white p-3 md:p-6 shadow-[0_40px_100px_-20px_rgba(0,0,0,0.15)] flex items-center justify-center ${slideshowImages.length === 0 ? 'opacity-0 pointer-events-none' : 'opacity-100'}`}
            >
              {/* Zone de clipping pour les images d'art */}
              <div className="relative w-full h-full overflow-hidden z-10 flex items-center justify-center">
                {slideshowImages.length > 0 ? (
                  <AnimatePresence mode="wait" initial={false}>
                    ...
                    >
                      ...
                      />
                      {/* Filtre de profondeur interne discret */}
