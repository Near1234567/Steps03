    ...
    >
        ...
        <div className="order-2 lg:order-1 flex flex-col items-center lg:items-start text-center lg:text-left space-y-8 lg:space-y-12 lg:pr-32 transition-transform duration-1000 lg:group-hover:-translate-x-20 pb-20 lg:pb-0">
          ...
          >
            <div className="flex items-center justify-center lg:justify-start space-x-6">
              ...
              <h2 className="text-[10px] md:text-[11px] uppercase tracking-[0.5em] text-zen-taupe font-bold">
                {t('hero.subtitle', { defaultValue: data.hero.subtitle })}
              </h2>
            </div>
          ...
          >
            ...
            <span className="text-sm uppercase tracking-widest text-zen-gold mt-4 block">
              {t('hero.location', { defaultValue: data.hero.location })}
            </span>
          </motion.p>
          ...
          >
            ...
            >
              <span className="relative z-10">
                {t('hero.collection', { defaultValue: data.ui.heroCollection })}
              </span>
                ...
                <AnimatePresence mode="wait">
                  ...
                  >
                    <img
                      ...
                      className="w-full h-full object-contain transition-transform duration-[8s] hover:scale-105 bg-transparent"
                    />
      ...
      >
        <span className="text-[9px] uppercase tracking-[0.6em] vertical-text">
          {t('hero.explore', { defaultValue: data.ui.heroExplore })}
        </span>
