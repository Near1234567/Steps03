...
const defaultData: SiteData = {
  ...
  ui: {
    ...
    inquiryMessage:
      "Je souhaiterais avoir plus d'informations concernant l'œuvre : ",

    formSuccess: "Message envoyé",

    footerCopyright:
      "Conception de Prestige • Tous droits réservés.",
  ...
  socials: {
    ...
    facebook:
      "https://www.facebook.com/asmae.laaroubi/",

    linkedin:
      "https://www.linkedin.com/in/asmaelaroubi",
  },
  ...
  const updateData = async (
    ...
    try {
      if (newData.artworks) {
        ...
        await dataService.syncArtworks(
          newData.artworks
        );
...
export const useSiteData = () => {
  ...
  if (!context) {
    throw new Error(
      'useSiteData must be used within SiteProvider'
    );
  }
